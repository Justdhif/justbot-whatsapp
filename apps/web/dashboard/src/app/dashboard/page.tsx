          ...
          <div className="glow-card rounded-2xl p-6 bg-zinc-950/40 border border-zinc-900">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link 
                ...
                className="flex items-center gap-1 text-[10px] font-semibold text-primary hover:underline bg-primary/10 border border-primary/20 px-2 py-1 rounded-md transition-all"
              >
                <ArrowUpRight className="h-3 w-3" /> Lihat Semua
              </Link>
            </div>
